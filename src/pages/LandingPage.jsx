...
export default function LandingPage({ onNavigate }) {
  const featuredDeals = [
    {
      id: 4,
      name: "Mediterranean Grill Set",
      restaurant: "The Conscious Kitchen",
      distance: "0.4 mi",
      originalPrice: 22.00,
      rescuePrice: 8.50,
      expiresIn: "4 mins left",
    ...
    {
      id: 5,
      name: "Artisan Brunch Platter",
      restaurant: "Green Sprout Cafe",
      distance: "1.2 mi",
      originalPrice: 14.50,
      rescuePrice: 6.00,
      expiresIn: "2 meals left",
    ...
    {
      id: 7,
      name: "Superfood Salmon Bowl",
      restaurant: "The Fresh Table",
      distance: "2.5 mi",
      originalPrice: 24.00,
      rescuePrice: 9.00,
      expiresIn: "High Impact",
    ...
    <div className="pt-16">
      ...
      <section className="relative px-6 py-20 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-5 relative">
          <div className="relative w-full aspect-square rounded-[3rem] overflow-hidden rotate-3 shadow-2xl border border-outline-variant/10">
            <img 
      ...
      {/* Impact Counter */}
      <section id="impact" className="bg-surface-container-low py-20 px-6 scroll-mt-20">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-surface p-10 rounded-[2rem] text-center shadow-[0_4px_20px_rgba(0,0,0,0.01)] border border-outline-variant/10">
              <span className="material-symbols-outlined text-4xl text-secondary mb-4 fill">eco</span>
              <div className="text-4xl font-extrabold text-on-background mb-2">14,200+</div>
              <div className="text-on-surface-variant font-medium text-sm">Meals Rescued</div>
            </div>
            <div className="bg-surface p-10 rounded-[2rem] text-center shadow-[0_4px_20px_rgba(0,0,0,0.01)] border border-outline-variant/10">
              <span className="material-symbols-outlined text-4xl text-primary mb-4 fill">co2</span>
              <div className="text-4xl font-extrabold text-on-background mb-2">35.4 Tons</div>
              <div className="text-on-surface-variant font-medium text-sm">CO2 Prevented</div>
            </div>
            <div className="bg-surface p-10 rounded-[2rem] text-center shadow-[0_4px_20px_rgba(0,0,0,0.01)] border border-outline-variant/10">
              <span className="material-symbols-outlined text-4xl text-tertiary mb-4 fill">savings</span>
              <div className="text-4xl font-extrabold text-on-background mb-2">$84k+</div>
              <div className="text-on-surface-variant font-medium text-sm">Saved by Users</div>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-on-surface">Browse</h4>
                    <p className="text-on-surface-variant text-sm mt-1">Discover high-end restaurant surplus nearby.</p>
                  </div>
                </div>
                <div className="flex items-start gap-5">
                  <div className="bg-white p-3 rounded-xl font-black text-secondary flex items-center justify-center w-10 h-10 shrink-0">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-on-surface">Order</h4>
                    <p className="text-on-surface-variant text-sm mt-1">Secure your meal through our glass-clean app.</p>
                  </div>
                </div>
                <div className="flex items-start gap-5">
                  <div className="bg-white p-3 rounded-xl font-black text-secondary flex items-center justify-center w-10 h-10 shrink-0">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-on-surface">Save</h4>
                    <p className="text-on-surface-variant text-sm mt-1">Pick up, enjoy, and reduce food waste.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <span className="material-symbols-outlined text-tertiary text-2xl">cancel</span>
                  <span className="font-bold text-on-surface text-base">Canceled Orders</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="material-symbols-outlined text-tertiary text-2xl">add_circle</span>
                  <span className="font-bold text-on-surface text-base">Instant Post</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="material-symbols-outlined text-tertiary text-2xl">trending_up</span>
                  <span className="font-bold text-on-surface text-base">Recover Revenue</span>
                </div>
              </div>
            </div>
            <div className="mt-8">
      ...
      {/* Featured Section: Live Deals UI */}
